            ...
            <Testimonial>
              <p>
                ...
                >
                  ...
                  these data and understand their impact on investment
                  strategies in order to make the best decisions.
                </ReactReadMoreReadLess>
              </p>
            </Testimonial>
          </ColumnOne>
            ...
            <Testimonial>
              <p>
                <ReactReadMoreReadLess
                  ...
                  readLessText={"Read less ▲"}
                >
                  We started from a real conviction: new technologies will
                  change the asset management world. With the increasing
                  complexity of the financial markets, our project aims to use
                  the most advanced techniques in artificial intelligence to
                  help asset managers. Our vision is that the machine
                  outperforms human intuition. We are on augmented intelligence.
                  The machine does not replace the manager, it is a decision
                  reinforcement tool. It is not trivial, hence our 4 years of
                  R&D with key people with a cutting edge expertise.
                </ReactReadMoreReadLess>
              </p>
            </Testimonial>
          </ColumnTwo>
